                ...
                <div class="card-body">
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">    
                            ...
                            <input type="text" value="<?= $data['name'];?>" name="name" placeholder="Enter Catergory Name" class="form-control" required>
                        </div>
                        <div class="col-md-6">                               
                        ...
                        <div class="col-md-12">                               
                            ...
                            <input type="text" value="<?= $data['name'];?>" name="meta_title" placeholder="Enter meta tittle" class="form-control"required>
                        </div>
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            ...
                            <textarea rows="3" name="meta_keywords"  placeholder="Enter Meta keywords" class="form-control"required><?= $data['meta_description']; ?></textarea>
                         </div>
                        <div class="col-md-6">                               
