                ...
                <div class="card-body">
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">                               
                            ...
                            <input type="text" name="name" placeholder="Enter Catergory Name" class="form-control" required>
                        </div>
                        <div class="col-md-6">                               
                        ...
                        <div class="col-md-12">                               
                            ...
                            <input type="" name="meta_title" placeholder="Enter meta tittle" class="form-control"required>
                        </div>
                        <div class="col-md-12">
